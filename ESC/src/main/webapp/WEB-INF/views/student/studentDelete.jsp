...
<main class="main">
  <section class="home">
    <h1><span>caution!</span></h1>
    <p>정말 철회하시겠습니까?</br>
    철회를 원하면 철회버튼을,   취소를 원하면 돌아가기 버튼을 눌러주세요.
    </p>
    
    <button id="reserv_delete" class="btn">자습철회</button>
    <button id="to_stu_main" class="btn">돌아가기</button>
  </section>
</main>

<script>
   // 코드 작성할 스크립트
   $("#reserv_delete").on("click", function (){
      window.location.href = "${pageContext.request.contextPath}/reserv_delete.do"
   });
   
   $("#to_stu_main").on("click", function (){
