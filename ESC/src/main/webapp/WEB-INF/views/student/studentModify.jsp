      ...
      <section class="sign-up">
         ...
         <article class="form-area">
            ...
            <div class="organize-form form-area-signin">
               <p style="font-size: 40px;">신청시간 수정페이지</p>
               ...
               <div style="border: 3px solid; padding: 10px; border-radius: 10px;">
                  <form action="modify.do">
                     ...
                     <select name="reservationTime" id="select_value" onchange="changeButtonColor()">
...
document.addEventListener("DOMContentLoaded", function() {
    // 로컬 스토리지에서 저장된 선택한 값 가져오기
    var selectedValueFromLocalStorage = localStorage.getItem("reservationTime");
    console.log(`selectedValueFromLocalStorage`);

    // select 요소를 가져옵니다.
    var selectElement = document.getElementById("select_value");

    // 선택하려는 값을 가진 옵션을 찾아서 selected 속성을 추가합니다.
    var options = selectElement.options;
    for (var i = 0; i < options.length; i++) {
        if (options[i].value == selectedValueFromLocalStorage) {
